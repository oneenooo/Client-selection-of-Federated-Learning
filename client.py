...
class Client(object):
    ...
    def configure(self, config):
        ...
        path = model_path + '/global_'+config.algorithm+"_"+str(config.clients.per_round)+"_"+ str(config.data.IID)
    ...
    def train(self,device):
        ...
        fl_model.train(self.model.to(device), trainloader,
                       self.optimizer, self.epochs,device)
...
class volatile_client(Client):
    """Simulated federated learning client."""

    def __init__(self, client_id,success_rate):
